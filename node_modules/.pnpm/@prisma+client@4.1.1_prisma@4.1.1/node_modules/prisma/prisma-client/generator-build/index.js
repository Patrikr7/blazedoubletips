...
var require_source = __commonJS({
  "../../node_modules/.pnpm/chalk@4.1.2/node_modules/chalk/source/index.js"(exports, module2) {
    ...
    var template;
    var chalkTag = /* @__PURE__ */ __name((chalk8, ...strings) => {
    ...
    module2.exports = (chalk7, tmp) => {
      ...
      tmp.replace(TEMPLATE_REGEX, (m2, escapeChar, inverse, style, close, chr) => {
        if (escapeChar) {
          ...
          chunk = [];
          chunks.push(styles.length === 0 ? str : buildStyle(chalk7, styles)(str));
          styles.push({ inverse, styles: parseStyle(style) });
        } else if (close) {
          if (styles.length === 0) {
            throw new Error("Found extraneous } in Chalk template literal");
  ...
  "../../node_modules/.pnpm/chalk@2.4.2/node_modules/chalk/index.js"(exports, module2) {
    ...
    function Chalk(options2) {
      if (!this || !(this instanceof Chalk) || this.template) {
        const chalk7 = {};
        applyOptions(chalk7, options2);
        chalk7.template = function() {
          const args = [].slice.call(arguments);
          return chalkTag.apply(null, [chalk7.template].concat(args));
        };
        Object.setPrototypeOf(chalk7, Chalk.prototype);
        Object.setPrototypeOf(chalk7.template, chalk7);
        chalk7.template.constructor = Chalk;
    ...
    function chalkTag(chalk7, strings) {
...
var require_lib2 = __commonJS({
  "../../node_modules/.pnpm/@babel+highlight@7.18.6/node_modules/@babel/highlight/lib/index.js"(exports) {
    ...
    function getDefs(chalk7) {
      return {
        keyword: chalk7.cyan,
        capitalized: chalk7.yellow,
        jsxIdentifier: chalk7.yellow,
        punctuator: chalk7.yellow,
        number: chalk7.magenta,
        string: chalk7.green,
        regex: chalk7.magenta,
        comment: chalk7.grey,
        invalid: chalk7.white.bgRed.bold
      };
    }
    ...
    function highlight(code, options2 = {}) {
      if (code !== "" && shouldHighlight(options2)) {
        const chalk7 = getChalk(options2);
        const defs = getDefs(chalk7);
...
var require_lib3 = __commonJS({
  "../../node_modules/.pnpm/@babel+code-frame@7.18.6/node_modules/@babel/code-frame/lib/index.js"(exports) {
    ...
    function getDefs(chalk7) {
      return {
        gutter: chalk7.grey,
        marker: chalk7.red.bold,
        message: chalk7.red.bold
      };
    }
    __name(getDefs, "getDefs");
    var NEWLINE = /\r\n|[\n\r\u2028\u2029]/;
    ...
    function codeFrameColumns(rawLines, loc, opts = {}) {
      ...
      const chalk7 = (0, _highlight.getChalk)(opts);
      const defs = getDefs(chalk7);
...
var require_spdx_license_ids = __commonJS({
  "../../node_modules/.pnpm/spdx-license-ids@3.0.11/node_modules/spdx-license-ids/index.json"(exports, module2) {
    module2.exports = [
      "0BSD",
      "AAL",
      "ADSL",
...
// ../../node_modules/.pnpm/is-core-module@2.9.0/node_modules/is-core-module/core.json
var require_core2 = __commonJS({
  "../../node_modules/.pnpm/is-core-module@2.9.0/node_modules/is-core-module/core.json"(exports, module2) {
    module2.exports = {
      assert: true,
...
// ../../node_modules/.pnpm/is-core-module@2.9.0/node_modules/is-core-module/index.js
var require_is_core_module = __commonJS({
  "../../node_modules/.pnpm/is-core-module@2.9.0/node_modules/is-core-module/index.js"(exports, module2) {
    "use strict";
        ...
        function load2(exts2, x3, loadPackage) {
          ...
          function onpkg(err2, pkg_, dir2) {
            ...
            if (dir2 && pkg2 && opts.pathFilter) {
              ...
              if (r2)
                return load2([""].concat(extensions.slice()), path9.resolve(dir2, r2), pkg2);
            }
            isFile(file2, onex);
          }
          __name(onpkg, "onpkg");
  ...
  "../../node_modules/.pnpm/temp-dir@2.0.0/node_modules/temp-dir/index.js"(exports, module2) {
    ...
    if (!global[tempDirectorySymbol]) {
      Object.defineProperty(global, tempDirectorySymbol, {
        value: fs13.realpathSync(os2.tmpdir())
      });
    }
...
// ../../node_modules/.pnpm/fp-ts@2.12.1/node_modules/fp-ts/lib/function.js
var require_function = __commonJS({
  "../../node_modules/.pnpm/fp-ts@2.12.1/node_modules/fp-ts/lib/function.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function patch(fs13) {
      ...
      function patchLchmod(fs14) {
        fs14.lchmod = function(path9, mode, callback) {
          fs14.open(path9, constants.O_WRONLY | constants.O_SYMLINK, mode, function(err, fd) {
            if (err) {
              if (callback)
                callback(err);
              return;
...
var require_cjs = __commonJS({
  "../../node_modules/.pnpm/@timsuchanek+sleep-promise@8.0.1/node_modules/@timsuchanek/sleep-promise/build/cjs.js"(exports, module2) {
    ...
    function sleep(a) {
      ...
      __name(b2, "b");
      var c = 1 < arguments.length && arguments[1] !== void 0 ? arguments[1] : {}, d2 = c.useCachedSetTimeout, e2 = createSleepPromise(a, { useCachedSetTimeout: d2 });
  ...
  "../../node_modules/.pnpm/flat-map-polyfill@0.3.8/node_modules/flat-map-polyfill/dist/cjs/flat-map.js"() {
    ...
    if (!Object.prototype.hasOwnProperty.call(Array.prototype, "flatMap")) {
      Array.prototype.flatMap = /* @__PURE__ */ __name(function flatMap(callbackFn, thisArg) {
        ...
        (0, _flattenIntoArray2.default)(a, o2, 0, 1, callbackFn, t2);
...
// ../../node_modules/.pnpm/fp-ts@2.12.1/node_modules/fp-ts/es6/function.js
...
// ../../node_modules/.pnpm/fp-ts@2.12.1/node_modules/fp-ts/es6/Functor.js
function map(F, G) {
  return function(f2) {
    return function(fa) {
...
// ../../node_modules/.pnpm/fp-ts@2.12.1/node_modules/fp-ts/es6/internal.js
...
// ../../node_modules/.pnpm/fp-ts@2.12.1/node_modules/fp-ts/es6/Either.js
var left2 = left;
var right2 = right;
...
// ../../node_modules/.pnpm/fp-ts@2.12.1/node_modules/fp-ts/es6/EitherT.js
function right3(F) {
...
// ../../node_modules/.pnpm/fp-ts@2.12.1/node_modules/fp-ts/es6/Task.js
...
// ../../node_modules/.pnpm/fp-ts@2.12.1/node_modules/fp-ts/es6/TaskEither.js
...
var readFile3 = (0, import_util6.promisify)(import_fs8.default.readFile);
var writeFile = (0, import_util6.promisify)(import_fs8.default.writeFile);
...
function safeResolveBinary(name, proposedPath) {
  return tryCatch2(() => resolveBinary(name, proposedPath), (error) => error);
}
...
var n = /* @__PURE__ */ __name((e2) => Boolean(e2 && typeof e2 == "object"), "n");
...
function preliminaryNodeAPIPipeline(options2) {
  return (0, import_function4.pipe)(tryCatch2(() => resolveBinary("libquery-engine" /* libqueryEngine */, options2.prismaPath), (e2) => ({
    type: "query-engine-unresolved",
    reason: "Unable to resolve path to query-engine binary",
    error: e2
  })), chainW((queryEnginePath) => {
    return (0, import_function4.pipe)(tryCatch2(isNodeAPISupported, (e2) => ({
...
function preliminaryBinaryPipeline(options2) {
  return (0, import_function4.pipe)(tryCatch2(() => resolveBinary("query-engine" /* queryEngine */, options2.prismaPath), (e2) => ({
    type: "query-engine-unresolved",
    reason: "Unable to resolve path to query-engine binary",
    error: e2
  })), map5((queryEnginePath) => ({ queryEnginePath })), chainW(({ queryEnginePath }) => {
    if (!options2.datamodelPath) {
      return (0, import_function4.pipe)(tryCatch2(() => (0, import_temp_write.default)(options2.datamodel), (e2) => ({
...
function loadNodeAPILibrary(queryEnginePath) {
  return (0, import_function4.pipe)(tryCatch(() => load(queryEnginePath), (e2) => {
    const error = e2;
    const defaultErrorMessage = `Unable to establish a connection to query-engine-node-api library.`;
    const proposedErrorFixMessage = K(error.message).when((errMessage) => errMessage.includes("openssl"), () => {
  ...
  }), fromEither, map5((NodeAPIQueryEngineLibrary) => ({ NodeAPIQueryEngineLibrary })));
}
...
var GetDmmfError = class extends Error {
  constructor(params) {
    const headline = import_chalk4.default.redBright.bold("Get DMMF: ");
...
${message}`;
      ...
      const detailsHeader = import_chalk4.default.red.bold("Details:");
      return `${reason}
...
async function getDmmfNodeAPI(options2) {
  ...
  const pipeline = (0, import_function5.pipe)(loadNodeAPILibrary(queryEnginePath), chainW(({ NodeAPIQueryEngineLibrary }) => {
    debug7("Loaded Node-API Library");
    return (0, import_function5.pipe)(tryCatch2(() => {
    ...
    return (0, import_function5.pipe)(tryCatch(() => JSON.parse(result), (e2) => ({
      type: "parse-json",
  ...
  const error = K(dmmfEither.left).with({ type: "node-api" }, (e2) => {
    ...
    const actualError = (0, import_function5.pipe)(tryCatch(() => JSON.parse(errorOutput), () => {
      debug7(`Coudln't apply JSON.parse to "${errorOutput}"`);
      ...
      if (errorOutputAsJSON.is_panic) {
        const panic = new RustPanic(errorOutputAsJSON.message, errorOutputAsJSON.backtrace || e2.error.stack || "NO_BACKTRACE", "query-engine-node-api get-dmmf", "QUERY_ENGINE_LIBRARY_CLI" /* QUERY_ENGINE_LIBRARY_CLI */, options2.prismaPath, e2.datamodel);
      ...
      return new GetDmmfError({
        ...
        reason: `${import_chalk4.default.redBright.bold("Schema parsing")} - ${e2.reason}`,
        errorCode
      });
...
async function getDmmfBinary(options2) {
  ...
  const pipeline = (0, import_function5.pipe)((() => {
    ...
    return tryCatch2(() => {
      if (process.env.FORCE_PANIC_QUERY_ENGINE_GET_DMMF) {
        debug7("Triggering a Rust panic...");
        return (0, import_execa2.default)(queryEnginePath, ["cli", "debug-panic", "--message", "FORCE_PANIC_QUERY_ENGINE_GET_DMMF"], execaOptions);
      }
    ...
    return (0, import_function5.pipe)(tryCatch(() => JSON.parse(stdout), (e2) => ({
      type: "parse-json",
      reason: "Unable to parse JSON",
      error: e2,
      result
  ...
  const errorEither = K(dmmfEither.left).with({ type: "execa" }, (e2) => {
    ...
    if (isExecaErrorCausedByRustPanic(e2.error)) {
      const panic = new RustPanic(e2.error.shortMessage, e2.error.stderr, "query-engine get-dmmf", "QUERY_ENGINE_BINARY_CLI" /* QUERY_ENGINE_BINARY_CLI */, (_a2 = options2.datamodelPath) != null ? _a2 : tempDatamodelPath, void 0);
      debug7(`panic in getDmmfBinary "${e2.type}"`, panic);
      return right2(panic);
    }
    const errorOutput = (_b = e2.error.stderr) != null ? _b : e2.error.stdout;
    const actualError = (0, import_function5.pipe)(tryCatch(() => JSON.parse(errorOutput), () => {
      debug7(`Coudln't apply JSON.parse to "${errorOutput}"`);
      return new GetDmmfError({ _tag: "unparsed", message: errorOutput, reason: e2.reason });
    }), map2((errorOutputAsJSON) => {
      const defaultMessage = addMissingOpenSSLInfo(`${import_chalk4.default.redBright(errorOutputAsJSON.message)}`);
      const { error_code: errorCode } = errorOutputAsJSON;
      return new GetDmmfError({
        _tag: "parsed",
        message: defaultMessage,
...
${(_a2 = e2.error) == null ? void 0 : _a2.stack}`;
    const error = new GetDmmfError({
      _tag: "unparsed",
      message,
      reason: `${import_chalk4.default.redBright.bold("JSON parsing")} - ${e2.reason}
`
    });
    return right2(error);
  }).with({ type: "retry" }, (e2) => {
  ...
  debug7(retryReason);
  return getDmmfBinary({ ...options2, retry: ((_a = options2.retry) != null ? _a : 0) - 1 });
}
...
function addMissingOpenSSLInfo(message) {
  if (message.includes("debian-openssl-1.1.x: error while loading shared libraries: libssl.so.1.1: cannot open shared object file: No such file or directory") || message.includes("debian-openssl-1.0.x: error while loading shared libraries: libssl.so.1.0.0: cannot open shared object file: No such file or directory")) {
    message += `
${import_chalk4.default.green(`Your linux installation misses the openssl package. You can install it like so:
`)}${import_chalk4.default.green.bold("apt-get -qy update && apt-get -qy install openssl")}`;
  }
  return message;
}
__name(addMissingOpenSSLInfo, "addMissingOpenSSLInfo");
function warnOnDeprecatedFeatureFlag(previewFeatures) {
  const getMessage = /* @__PURE__ */ __name((flag) => `${import_chalk4.default.blueBright("info")} The preview flag "${flag}" is not needed anymore, please remove it from your schema.prisma`, "getMessage");
...
function getArgFieldJSDoc(type, action, field) {
  ...
  if (JSDocs[action] && ((_a = JSDocs[action]) == null ? void 0 : _a.fields[fieldName])) {
    ...
    const comment = (_b = JSDocs[action]) == null ? void 0 : _b.fields[fieldName](singular, plural);
    return comment;
  }
  return void 0;
}
...
__name(ExportCollector, "ExportCollector");
...
function stringifyInputType(t2, prefixFilter, noEnumerable = false) {
  var _a;
...
var InputType = class {
  ...
  toTS() {
    ...
    const body = `{
${(0, import_indent_string3.default)(fields.map((arg) => {
...
${(0, import_indent_string4.default)(argsToGenerate.map((arg) => new InputField(arg).toTS()).join("\n"), TAB_SIZE)}
}
`;
  }
...
${(0, import_indent_string4.default)(args.map((arg) => {
...
function JS(gen, edge = false) {
  var _a, _b;
  return (_b = (_a = gen.toJS) == null ? void 0 : _a.call(gen, edge)) != null ? _b : "";
}
__name(JS, "JS");
function BrowserJS(gen) {
  var _a, _b;
  return (_b = (_a = gen.toBrowserJS) == null ? void 0 : _a.call(gen)) != null ? _b : "";
}
...
var OutputType = class {
  constructor(dmmf2, type, collector) {
    this.dmmf = dmmf2;
    this.type = type;
    this.collector = collector;
    this.name = type.name;
...
${(0, import_indent_string6.default)(type.fields.map((field) => new OutputField(this.dmmf, { ...field, ...field.outputType }).toTS()).join("\n"), TAB_SIZE)}
}`;
  }
};
...
var PayloadType = class {
  constructor(type, findMany = true) {
    this.type = type;
...
`;
  ...
  renderRelations(projection) {
    const { type } = this;
    const relations = type.fields.filter((f2) => f2.outputType.location === "outputObjectTypes");
    if (relations.length === 0 && projection === "include" /* include */) {
      return "";
    }
    const selectPrefix = projection === "select" /* select */ ? ` P extends keyof ${type.name} ? ${type.name}[P] :` : "";
    return `{
  [P in TrueKeys<S['${projection}']>]:
${(0, import_indent_string7.default)(relations.map((f2) => `P extends '${f2.name}' ? ${this.wrapType(f2, `${getPayloadName(f2.outputType.type.name)}<S['${projection}'][P]>`)} :`).join("\n"), 6)} ${selectPrefix} never
} `;
  }
  wrapType(field, str) {
...
var SchemaOutputType = class {
  ...
  toTS() {
    ...
    return `
export type ${type.name} = {
${(0, import_indent_string8.default)(type.fields.map((field) => new SchemaOutputField({ ...field, ...field.outputType }).toTS()).join("\n"), TAB_SIZE)}
}`;
  }
};
...
// src/generation/TSClient/Model.ts
var Model = class {
  constructor(model, dmmf2, generator2, collector) {
    this.model = model;
    this.dmmf = dmmf2;
  ...
  get argsTypes() {
    ...
    for (const action of allClientModelActions) {
      ...
      if (action === "updateMany" || action === "deleteMany" || action === "createMany") {
        argsTypes.push(new MinimalArgsType(field.args, this.type, action, this.collector));
  ...
  rootFieldNameForAction(action) {
    var _a;
    return (_a = this.mapping) == null ? void 0 : _a[getDmmfActionName(action)];
  }
  getGroupByTypes() {
...
${(0, import_indent_string9.default)(groupByRootField.args.map((arg) => {
      arg.comment = getArgFieldJSDoc(this.type, DMMF.ModelAction.groupBy, arg);
      return new InputField(arg, false, arg.name === "by").toTS();
    }).concat(groupByType.fields.filter((f2) => f2.outputType.location === "outputObjectTypes").map((f2) => {
...
export type ${getAggregateGetName(model.name)}<T extends ${getAggregateArgsName(model.name)}> = {
  ...
  toTSWithoutNamespace() {
    var _a;
    const { model } = this;
    const docLines = (_a = model.documentation) != null ? _a : "";
    const modelLine = `Model ${model.name}
`;
    const docs = `${modelLine}${docLines}`;
    return `${buildComment(docs)}export type ${model.name} = {
${(0, import_indent_string9.default)(model.fields.filter((f2) => f2.kind !== "object" && f2.kind !== "unsupported" || this.dmmf.typeMap[f2.type]).map((field) => new ModelOutputField(this.dmmf, field, !this.dmmf.typeMap[field.type]).toTS()).join("\n"), TAB_SIZE)}
}
`;
  }
  toTS() {
...
${(0, import_indent_string9.default)(outputType.fields.filter((f2) => {
...
${(0, import_indent_string9.default)(outputType.fields.map((f2) => {
      const fieldTypeName = f2.outputType.type.name;
      return `${f2.name}?: boolean` + (f2.outputType.location === "outputObjectTypes" ? ` | ${getFieldArgName(f2, !this.dmmf.typeMap[fieldTypeName])}` : "");
    }).join("\n"), TAB_SIZE)}
}
...
var ModelDelegate = class {
  ...
  toTS() {
    ...
    const mapping = (_a = this.dmmf.mappingsMap[name]) != null ? _a : { model: name, plural: `${name}s` };
    const modelOrType = this.dmmf.typeAndModelMap[name];
    const mappingKeys = Object.keys(mapping);
    const availableActions = mappingKeys.filter((key) => key !== "model" && key !== "plural" && mapping[key]);
...
${(0, import_indent_string9.default)(nonAggregateActions.map((actionName) => `${getMethodJSDoc(actionName, mapping, modelOrType)}
${actionName}${getGenericMethod(name, actionName)}(
  ${getArgs(name, actionName)}
): ${getReturnType({ name, actionName, projection: "select" /* select */ })}`).join("\n\n"), TAB_SIZE)}
...
${availableActions.includes(DMMF.ModelAction.groupBy) ? `${(0, import_indent_string9.default)(getMethodJSDoc(DMMF.ModelAction.groupBy, mapping, modelOrType), TAB_SIZE)}
  ...
  >(args: SubsetIntersection<T, ${groupByArgsName}, OrderByArg> & InputErrors): {} extends InputErrors ? ${getGroupByPayloadName(name)}<T> : PrismaPromise<InputErrors>` : ""}
}
...
${(0, import_indent_string9.default)(fields.filter((f2) => f2.outputType.location === "outputObjectTypes" && f2.name !== "_count").map((f2) => {
      const fieldTypeName = f2.outputType.type.name;
      return `
${f2.name}<T extends ${getFieldArgName(f2, !this.dmmf.typeMap[fieldTypeName])} = {}>(args?: Subset<T, ${getFieldArgName(f2, !this.dmmf.typeMap[fieldTypeName])}>): ${getReturnType({
        name: fieldTypeName,
...
function applyMixins(derivedCtor, constructors) {
  ...
  for (const baseCtor of constructors) {
    for (const name of Object.getOwnPropertyNames(baseCtor.prototype)) {
      Object.defineProperty(derivedCtor.prototype, name, (_a = Object.getOwnPropertyDescriptor(baseCtor.prototype, name)) != null ? _a : /* @__PURE__ */ Object.create(null));
    }
  }
}
...
var Count = class {
  constructor(type, dmmf2, generator2, collector) {
    this.type = type;
    this.dmmf = dmmf2;
    this.generator = generator2;
    this.collector = collector;
...
${(0, import_indent_string11.default)(type.fields.map((f2) => `${f2.name}?: boolean` + (f2.outputType.location === "outputObjectTypes" ? ` | ${getFieldArgName(f2)}` : "")).join("\n"), TAB_SIZE)}
}
...
function interactiveTransactionDefinition() {
  var _a;
  if (!((_a = this.generator) == null ? void 0 : _a.previewFeatures.includes("interactiveTransactions"))) {
    return "";
  }
...
function metricDefinition() {
  var _a;
  if (!((_a = this.generator) == null ? void 0 : _a.previewFeatures.includes("metrics"))) {
    return "";
  }
  return `
  /**
...
${[
    ...
    ${(0, import_indent_string13.default)(dmmf2.mappings.modelOperations.filter((m2) => m2.findMany).map((m2) => {
...
${((_a = this.generator) == null ? void 0 : _a.previewFeatures.includes("interactiveTransactions")) ? `
...
`;
  ...
  toTS(edge = false) {
    ...
    const prismaClientClass = new PrismaClientClass(this.dmmf, this.options.datasources, this.options.outputDir, this.options.browser, this.options.generator, this.options.sqliteDatasourceOverrides, import_path7.default.dirname(this.options.schemaPath));
    ...
    const countTypes = this.dmmf.schema.outputObjectTypes.prisma.filter((t2) => t2.name.endsWith("CountOutputType")).map((t2) => new Count(t2, this.dmmf, this.options.generator, collector));
    const code = `
/**
 * Client
**/
...
${(0, import_indent_string14.default)(`${commonCode.ts()}
${new Enum({
      name: "ModelName",
      values: this.dmmf.mappings.modelOperations.map((m2) => m2.model)
    }, true, collector).toTS()}
...
// src/generation/generateClient.ts
var remove = (0, import_util7.promisify)(import_fs12.default.unlink);
var writeFile2 = (0, import_util7.promisify)(import_fs12.default.writeFile);
var exists4 = (0, import_util7.promisify)(import_fs12.default.exists);
var copyFile = (0, import_util7.promisify)(import_fs12.default.copyFile);
var stat = (0, import_util7.promisify)(import_fs12.default.stat);
...
async function buildClient({
  ...
  const tsClientOptions = {
    ...
    datasources: datasources2,
    generator: generator2,
    platforms: clientEngineType2 === "library" /* Library */ ? Object.keys((_a = binaryPaths2.libqueryEngine) != null ? _a : {}) : Object.keys((_b = binaryPaths2.queryEngine) != null ? _b : {}),
    schemaPath: schemaPath2,
    outputDir: outputDir2,
    clientVersion: clientVersion3,
    engineVersion: engineVersion2,
...
async function generateClient(options) {
  ...
  if (denylistsErrors) {
    let message = `${import_chalk6.default.redBright.bold("Error: ")}The schema at "${schemaPath}" contains reserved keywords.
...
To learn more about how to rename models, check out https://pris.ly/d/naming-models`;
  ...
  await Promise.all(Object.entries(fileMap).map(async ([fileName, file2]) => {
  ...
  if (!enginePath) {
    throw new Error(`Prisma Client needs \`${clientEngineType === "library" /* Library */ ? "libqueryEngine" : "queryEngine"}\` in the \`binaryPaths\` object.`);
  }
...
async function getGenerationDirs({ testMode: testMode2, runtimeDirs: runtimeDirs2, generator: generator2, outputDir: outputDir2 }) {
  ...
  generatorHandler({
    ...
    async onGenerate(options2) {
      ...
      return generateClient({
        ...
        transpile: true,
        activeProvider: (_a = options2.datasources[0]) == null ? void 0 : _a.activeProvider,
